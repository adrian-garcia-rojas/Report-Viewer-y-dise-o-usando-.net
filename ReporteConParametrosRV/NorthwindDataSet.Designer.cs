...
namespace ReporteConParametrosEF.NorthwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Products] ([ProductName], [UnitPrice], [UnitsInStock]) VALUES (@Prod" +
                ...
                "UnitsInStock FROM Products WHERE (ProductID = SCOPE_IDENTITY())";
...
SELECT ProductID, ProductName, UnitPrice, UnitsInStock FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ReporteConParametrosEF.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        public virtual int mostrarTodos(NorthwindDataSet.ProductsDataTable dataTable) {
        ...
        public virtual int filtroPorProducto(NorthwindDataSet.ProductsDataTable dataTable, string ProductName) {
        ...
        public virtual NorthwindDataSet.ProductsDataTable GetDataBy(string ProductName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
